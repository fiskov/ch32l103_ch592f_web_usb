 ...
 *******************************************************************************/
#ifndef USER_USBD_WINUSB_H_
#define USER_USBD_WINUSB_H_
 ...
 *          requests: the Microsoft OS 2.0 descriptor request, and the
 *          application-specific LED get/set brightness requests.
 *
