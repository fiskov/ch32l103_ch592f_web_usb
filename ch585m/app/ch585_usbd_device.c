...
void USBD_Device_Init(void)
{
    ...
    R32_UEP0_DMA = (uint32_t)s_EP0_Buf;
    R32_UEP1_DMA = (uint32_t)s_EP1_Buf;
    R32_UEP2_DMA = (uint32_t)s_EP2_Buf;
    R32_UEP3_DMA = (uint32_t)s_EP3_Buf;
